...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_discon_net->setGeometry(QRect(12, 103, 127, 25));
        indicatorQml = new QQuickWidget(groupBox);
        indicatorQml->setObjectName(QStringLiteral("indicatorQml"));
        indicatorQml->setGeometry(QRect(70, 20, 221, 111));
        indicatorQml->setResizeMode(QQuickWidget::SizeRootObjectToView);
        indicatorQml->setSource(QUrl(QStringLiteral("qrc:/indicator.qml")));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_con_net->setText(QApplication::translate("MainWindow", "test network", nullptr));
