...
QT_MOC_LITERAL(4, 50, 18) // "send_road_boundary"

    },
    "Pathplan\0read_path_plan\0\0"
    "send_path_info_to_camera\0send_road_boundary"
};
...
void Pathplan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->send_road_boundary((*reinterpret_cast< quint16(*)>(_a[1])),(*reinterpret_cast< quint16(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pathplan::read_path_plan)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (Pathplan::*_t)(quint16 , quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pathplan::send_road_boundary)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Pathplan::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Pathplan.data,
      qt_meta_data_Pathplan,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 2
void Pathplan::send_road_boundary(quint16 _t1, quint16 _t2)
{
