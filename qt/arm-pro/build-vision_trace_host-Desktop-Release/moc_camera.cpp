...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::show_frame)) {
                *result = 0;
            }
        }
        {
            typedef void (Camera::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::show_frame_2)) {
                *result = 1;
            }
        }
        {
            typedef void (Camera::*_t)(qint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::show_tutlebot_status)) {
                *result = 2;
            }
        }
        {
            typedef void (Camera::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_up)) {
                *result = 3;
            }
        }
        {
            typedef void (Camera::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_down)) {
                *result = 4;
            }
        }
        {
            typedef void (Camera::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_right)) {
                *result = 5;
            }
        }
        {
            typedef void (Camera::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_left)) {
                *result = 6;
            }
        }
        {
            typedef void (Camera::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_turn)) {
                *result = 7;
            }
        }
        {
            typedef void (Camera::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::turltebot_stop)) {
                *result = 8;
            }
        }
        {
            typedef void (Camera::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::show_command)) {
                *result = 9;
            }
        }
        {
            typedef void (Camera::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::send_info_to_pc)) {
                *result = 10;
            }
        }
        {
            typedef void (Camera::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::update_path_node)) {
                *result = 11;
            }
        }
        {
            typedef void (Camera::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::update_path_start_node)) {
                *result = 12;
            }
        }
    }
