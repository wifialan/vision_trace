...
# 1. 首次连接之前，在 ROS master所在环境用以下命令安装**rosbridge suite**:

https://roslibpy-docs-zh.readthedocs.io/zh/latest/api.html#ros-setup
...
https://blog.csdn.net/Hsin96/article/details/89603499
